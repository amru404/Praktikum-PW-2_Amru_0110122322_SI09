...
$result = "SELECT * FROM produk WHERE id=?"; 
$st = $dbh->prepare($result);
$st->execute([$id]);
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        value="<?= $rs['harga_beli'] ?>" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="stok" name="stok" value="<?= $rs['stok'] ?>"
