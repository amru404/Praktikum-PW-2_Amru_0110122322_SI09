                ...
                <div class="card shadow mb-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="input-group">
                                ...
                                <input id="kode" name="kode" disabled type="text" value=<?= $kode;?> class="form-control">
                            </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input id="nama" name="nama" disabled type="text" value=<?= $nama;?> class="form-control">
                            </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input id="harga_jual" name="harga_jual" disabled type="text" value=<?= $hargaJual;?> class="form-control">
                            </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input id="harga_beli" name="harga_beli" disabled type="text" value=<?= $hargaBeli;?> class="form-control">
                            </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input id="stok" name="stok" disabled type="text" value=<?= $stok;?> class="form-control">
                            </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input id="min_stok" name="min_stok" disabled type="text" value=<?= $minstok;?> class="form-control">
                            </div>
                            </div>
                            ...
                            <div class="col-8">
                            <textarea disabled class="form-control" id="deskripsi"  name="deskripsi" rows="3"><?= $deskripsi;?></textarea>
                            </div>  
                        </div>
                        ...
                        <div class="col-8">
                            <?php 
                                $sqljenis = "SELECT * FROM kategori_produk where id = $kategori";
                                $rsjenis = $mysqli->query($sqljenis);
                            ?>
                        <select id="kategori" name="kategori" disabled class="custom-select" value="<?= $deskripsi?>">
                            <?php 
                        ...
                        <td><input disabled type="hidden" name="id" value=<?= $_GET['id'];?>></td>
                        <div class="form-group row">
