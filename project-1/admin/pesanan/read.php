                ...
                <div class="card shadow mb-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="input-group">
                                ...
                                <input id="tanggal" name="tanggal" type="date" disabled value=<?= $tanggal;?>  class="form-control">
                            </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input id="nama_pemesan" name="nama_pemesan" type="text" disabled value=<?= $nama_pemesan;?> class="form-control">
                            </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input id="alamat_pemesan" name="alamat_pemesan" type="text" disabled value= class="form-control">
                            </div>
                            </div> -->
                            ...
                            <label for="alamat_pemesan" class="col-4 col-form-label">Alamat Pemesan</label>
                            <div class="col-8">
                            <textarea class="form-control" disabled id="alamat_pemesan"  name="alamat_pemesan" rows="3"><?= $alamat;?></textarea>
                            </div>
                        </div>
                            ...
                            <div class="input-group">
                                ...
                                <input id="no_hp" name="no_hp" type="number" disabled value=<?= $nohp;?> class="form-control">
                            </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input id="email" name="email" type="text" disabled value=<?= $email;?> class="form-control">
                            </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input id="qty" name="qty" type="number" disabled value=<?= $qty;?> class="form-control">
                            </div>
                            </div>
                            ...
                            <div class="col-8">
                            <textarea class="form-control" disabled id="deskripsi"  name="deskripsi" rows="3"><?= $deskripsi;?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-8">
                            <?php 
                                $sqljenis = "SELECT * FROM produk where id = $produk";
                                // var_dump($sqljenis);
                                $rsjenis = $mysqli->query($sqljenis);
                            ?>
                        <select id="produk_id" name="produk_id" class="custom-select" disabled value="<?= $deskripsi?>">
                            <?php 
