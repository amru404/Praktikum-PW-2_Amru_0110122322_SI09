                ...
                <div class="card shadow mb-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="input-group">
                                ...
                                <input id="nama" disabled name="nama" type="text" value=<?php echo $_GET['id'];?> class="form-control">
                            </div>
                            </div>
                        <div class="form-group row">
                            ...
                            <div class="input-group">
                                ...
                                <input id="nama" disabled name="nama" type="text" value=<?php echo $nama;?> class="form-control">
                            </div>
                            </div>
