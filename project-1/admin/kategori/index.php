...
$result = mysqli_query($mysqli, "SELECT * FROM kategori_produk ORDER BY id ASC");
...
if(isset($_POST['Submit'])) {
        ...
        $hasil = mysqli_query($mysqli, "INSERT INTO kategori_produk(nama) VALUES('$nama')");
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $no?></td>
                                                <td><?= $kategori['nama'] ?></td>
                                                <td><a class="btn btn-sm btn-success" href="read.php?id=<?=$kategori['id']?>">View</a> <a class="btn btn-sm btn-warning" href="edit.php?id=<?=$kategori['id']?>">Edit</a> <a class="btn btn-sm btn-danger" href="delt.php?id=<?=$kategori['id']?>">Delete</a></td>
