...
<!--     
      ...
      <div class="row">
        ...
        <div class="col-xl-8 col-sm-8 col-12  mb-xl-0 mb-4">
          <div class="card">
            <div class="card-body p-3">
              <form action="index.php" method="POST" style="display:flex; justify-content:center" class="form-buy">
                <div class="row" style="display:flex; justify-content:center">
                  ...
                  <div class="col-5 col-md-3 col-sm-4 col-">
                    ...
                    <input type="text" style="width:120px;" class="form-control" required name="nama_pemesan" id="nama_pemesan">
                  </div>
                  <div class="col-5 col-md-3 col-sm-4 col-">
                    <label for="alamat_pemesan">Alamat</label>
                    <input type="text" style="width:120px;" class="form-control" required name="alamat_pemesan" id="alamat_pemesan">
                  </div>
                  <div class="col-5 col-md-3 col-sm-4 col-">
                    <label for="no_hp">No Hp</label>
                    <input type="number" style="width:120px;" class="form-control" required name="no_hp" id="no_hp">
                  </div>
                  <div class="col-5 col-md-3 col-sm-4 col-">
                    <label for="email">Email</label>
                    <input type="email" style="width:120px;" class="form-control" required name="email" id="email">
                  </div>
                  <div class="col-5 col-md-3 col-sm-4 col-">
                    <label for="qty">Quantity</label>
                    <input type="number" style="width:120px;" class="form-control" required name="qty" id="qty">
                  </div>
                  <div class="col-5 col-md-3 col-sm-4 col-">
                    <label for="deskripsi">Deskripsi</label>
                    <input type="text" style="width:120px;" class="form-control" required name="deskripsi" id="deskripsi">
                  </div>
                  <div class="col-5 col-md-3 col-sm-4 col-">
        ...
        <div class="row" >
          ...
          ?>
          <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4"  style="display:flex;justify-content:center;">
