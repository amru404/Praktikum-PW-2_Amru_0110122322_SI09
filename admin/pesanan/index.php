        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                        ...
                        <a class="btn btn-primary m-3" style="width:auto;" href="add.php">Tambah Pesanan</a>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $pesanan['no_hp'] ?></td>
                                                <td><?= $pesanan['qty'] ?></td>
                                                <td><a class="btn btn-sm btn-success" href="read.php?id=<?=$pesanan['id']?>">View</a> <a class="btn btn-sm btn-warning" href="edit.php?id=<?=$pesanan['id']?>">Edit</a> <a class="btn btn-sm btn-danger" href="delt.php?id=<?=$pesanan['id']?>">Delete</a></td>
